#### This code cleans GEE data to create the test dataset (1990-1999)
...
un_urban_dist <- read.csv('raw-data/gee-data/cleaned_schisto_urbanCC_UN_interpolated_oct172023.csv')
ar_urban_dist <- read.csv('raw-data/gee-data/cleaned_schisto_urbanCC_AR_interpolated_oct172023.csv')
rural_distance <- read.csv('raw-data/gee-data/cleaned_schisto_ruralCC_interpolated_oct162023.csv')

########## urban distance goes from 1990-1999 so the final dataframe goes from 1990-1999
...
climate_filtered_wide <- transform_bios(climate_filtered_wide)
...
#save data
saveRDS(final_data_lat_long, "clean-data/test_data_sdm_oct18.rds")
