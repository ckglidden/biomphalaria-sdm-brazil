## Code to clean (thin) test (hindcasting) dataset for B. straminea
...
##-----------------------------------------------------------------##
hist_environmental_covariate_df$presence <- ifelse(grepl("straminea", hist_environmental_covariate_df$species), "1", "0")
...
thin.occ <- presence_hist[row.names(s),] # 33 obs
...
thin.bkg <- bkg_hist[row.names(ss),] #1691 obs
...
saveRDS(analysis_data_final_AR, "clean-data/straminea/straminea_AR_test_data_oct18.rds")
saveRDS(analysis_data_final_UN, "clean-data/straminea/straminea_UN_test_data_oct18.rds")
