...
#analysis_data_final <- readRDS("../clean data/straminea_brt_data_oct8.rds")
analysis_data_final <- readRDS("straminea_UN_brt_data_oct12.rds")
...
write.csv(brt_performance, "straminea_brt_model_performance_UN.csv")
