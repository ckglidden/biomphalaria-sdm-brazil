### Code to estimate model performance for the B. straminea model using 5-fold cross validation
...
analysis_data_final <- readRDS("clean-data/straminea/straminea_UN_brt_data_oct12.rds")
...
write.csv(brt_performance, "output/straminea/straminea_brt_model_performance_UN.csv")
