### B. straminea model code for bootstrapping for VIP and PDPs
...
#read in final data.     #
#------------------------#
analysis_data <- readRDS("clean-data/straminea/straminea_UN_brt_data_oct12.rds")
...
write.csv(pd_df_all, "output/straminea/straminea_brt_pd_df_bootstrapping_UN.csv") 
write.csv(means_df, "output/straminea/straminea_brt_shap_importance_bootstrapping_UN.csv")
