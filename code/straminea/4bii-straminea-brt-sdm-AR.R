...
analysis_data_final <- readRDS("clean-data/straminea/straminea_AR_brt_data_oct12.rds")
...
write.csv(brt_performance, "output/straminea/straminea_brt_model_performance_AR.csv")
