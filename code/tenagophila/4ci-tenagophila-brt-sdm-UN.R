### Code to estimate model performance for the B. tenagophila model using 5-fold cross validation
...
analysis_data_final <- readRDS("clean-data/tenagophila/tenagophila_UN_brt_data_oct12.rds")
...
write.csv(brt_performance, "output/tenagophila/tenagophila_brt_model_performance_UN.csv")
