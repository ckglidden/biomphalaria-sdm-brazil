### code to test model performance using spatial CV for the B. tenagophila model (UN def of urban)
...
analysis_data_final <- readRDS("tenagophila_UN_brt_data_oct12.rds")
...
write.csv(brt_performance, "tenagophila_brt_model_performance_UN.csv")
