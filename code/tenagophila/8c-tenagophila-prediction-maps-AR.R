...
analysis_data <- readRDS("tenagophila_AR_brt_data_oct12.rds")
observed_1992 <- readRDS('../prediction-map-rds/sdm_data_1992.rds')
observed_2017 <- readRDS('../prediction-map-rds/sdm_data_2017.rds')
climate_counterfactual <- readRDS('../prediction-map-rds/sdm_climate_counterfactual.rds')
urban_counterfactual <- readRDS('../prediction-map-rds/sdm_urban_counterfactual.rds')
...
for(i in 1:25){
  ...
  hist_path <- paste0('geoTiffs/hist_raster_',i,'.tif')
  current_path <- paste0('geoTiffs/current_raster_',i,'.tif')
  climate_path <- paste0('geoTiffs/climate_counterfactual_',i,'.tif')
