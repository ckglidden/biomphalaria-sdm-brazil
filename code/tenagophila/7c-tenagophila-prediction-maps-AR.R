### B. tenagophila model code for estimating Brazil wide model predictions for the historical, current, and counterfacutal distributions
...
#read in final data.     #
#------------------------#
analysis_data <- readRDS("clean-data/tenagophila/tenagophila_AR_brt_data_oct12.rds")
...
for(i in 1:25){
  ...
  hist_path <- paste0('output/tenagophila/geoTiffs/hist_raster_',i,'.tif')
  current_path <- paste0('output/tenagophila/geoTiffs/current_raster_',i,'.tif')
  climate_path <- paste0('output/tenagophila/geoTiffs/climate_counterfactual_',i,'.tif')
  urban_path <- paste0('output/tenagophila/geoTiffs/urban_counterfactual_',i,'.tif')
