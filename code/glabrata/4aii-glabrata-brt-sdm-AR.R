### B. glabrata model performance w/ 5-fold spatial CV
...
#read in final data.     #
#------------------------#
analysis_data_final <- readRDS("clean-data/glabrata/glabrata_AR_brt_data_oct12.rds")
...
write.csv(brt_performance, "output/glabrata/glabrata_brt_model_performance_AR.csv")
