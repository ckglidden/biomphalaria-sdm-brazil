### B. glabrata model code for estimating Brazil wide model predictions for the historical, current, and counterfacutal distributions
...
for(i in 1:25){
  ...
  hist_path <- paste0('output/glabrata/geoTiffs/hist_raster_',i,'.tif')
  current_path <- paste0('output/glabrata/geoTiffs/current_raster_',i,'.tif')
  climate_path <- paste0('output/glabrata/geoTiffs/climate_counterfactual_',i,'.tif')
  urban_path <- paste0('output/glabrata/geoTiffs/urban_counterfactual_',i,'.tif')
