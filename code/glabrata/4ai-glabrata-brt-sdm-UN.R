### code to test model performance using spatial CV for the B. glabrata model (UN def of urban)
...
#analysis_data_final <- readRDS("../clean data/glabrata/glabrata_brt_data_oct8.rds")
analysis_data_final <- readRDS("glabrata_UN_brt_data_oct12.rds")
...
write.csv(brt_performance, "glabrata_brt_model_performance_UN.csv")
